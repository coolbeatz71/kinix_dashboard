...
export const IMAGES_API_CLOUD_NAME = process.env.REACT_APP_CLOUDINARY_CLOUD_NAME as string;

export const API_URL = process.env.REACT_APP_API_URL;

export const JWT_SECRET_KEY = process.env.REACT_APP_JWT_SECRET_KEY;
export const CRYPTO_PASSPHASE = process.env.REACT_APP_CRYPTO_PASSPHASE;
...
export const LOGO_LARGE_DARK = '/logo/large_dark.svg';

export const APP_NAME = "Kinshas'Art";
export const APP_AUTHOR = `${APP_NAME} Communication`;
