...
import emailValidator, { countryNameValidator, partialPhoneValidator, userNameValidator } from './validator';
import countryList from '@constants/countryList';
import { resetUpdateAccountAction } from '@redux/auth/updateAccount';
...
const UpdateAccountForm: FC<IUpdateAccountProps> = ({ initialValues }) => {
    ...
    const countryName = useWatch('countryName', form);
    ...
    useEffect(() => {
        if (countryName) {
            const selectedCountry = countryList.find((ct: ICountryObject) => ct.name === countryName);
        ...
        <Card bordered className={styles.updateAccount}>
            ...
            >
                ...
                <Item
                    name="partialPhone"
                    validateTrigger={['onSubmit', 'onBlur']}
                    rules={partialPhoneValidator('Téléphone', country?.dialCode)}
                >
